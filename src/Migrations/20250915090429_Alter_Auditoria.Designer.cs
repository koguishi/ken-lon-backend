...
namespace kendo_londrina.Migrations
{
    ...
    [Migration("20250915090429_Alter_Auditoria")]
    partial class Alter_Auditoria
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuditoriaEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("AuditoriaEntries", (string)null);
                });
            ...
            modelBuilder.Entity("kendo_londrina.Domain.Entities.ContaPagar", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("kendo_londrina.Domain.Entities.ContaReceber", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("MeioRecebimento")
                        .HasMaxLength(50)
                        .HasColumnType("varchar");
                    ...
                    b.Property<string>("ObsRecebimento")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar");
            ...
            modelBuilder.Entity("kendo_londrina.Domain.Entities.ContaPagar", b =>
                {
                    ...
                    b.HasOne("kendo_londrina.Domain.Entities.Pessoa", "Pessoa")
                        .WithMany("ContasPagar")
                        .HasForeignKey("PessoaId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("kendo_londrina.Domain.Entities.SubCategoria", "SubCategoria")
                        .WithMany("ContasPagar")
